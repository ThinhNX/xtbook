...
<title>
	Trang Quản Trị Shop Sách XT BOOK
</title>
	...
	<table border="0" cellpadding="0" cellspacing="0" width="960" align="center" style="margin-top:20px; margin-bottom:20px; background:#FFFFFF;">
		<tr>
			<td height="40" style="color:#FFFFCC; background:#66A111;" colspan="2" align="center">
				ADMIN CONTROL PANEL - SHOP XT BOOK
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<div class="menuleft">
					<a href="#" onclick="adm_chuyentrang('quanlyloaiqua')">Quản Lý Loại Sách</a>
					<a href="#" onclick="adm_chuyentrang('quanlyqua')">Quản Lý Sách</a>
			...
			background:#FFFFFF; color:#999999; text-align:left; border-right:none; border-left:none;">
                    ...
                    <span class="demuc"> Tổng Số Loại Sách:</span> <?php echo $soloaiqua; ?> </a>
					<br />
                    <a href="#" onclick="adm_chuyentrang('quanlyqua')">
					<span class="demuc">Tổng Số Sách:</span> <?php echo $soqua; ?></a>	
					<br />
